...
class HydratorAggregator extends atoum
{
    ...
    public function testHydrateEnableBCBreakShouldRaiseException()
    {
        $services = new \CCMBenchmark\Ting\Services();
        $metadata = new \CCMBenchmark\Ting\Repository\Metadata($services->get('SerializerFactory'));
        $metadata->setConnectionName('connectionName');
        ...
        $this
            ...
            ->exception(function () use ($iterator) {
                ...
                ->hasMessage("Identifier " . $data['bouh']->getId() . " already generated, please sort your result by identifier")
        ;
    }

    public function testHydrateWithoutBCBreakShouldContinue()
    {
        $services = new \CCMBenchmark\Ting\Services();
        $metadata = new \CCMBenchmark\Ting\Repository\Metadata($services->get('SerializerFactory'));
        $metadata->setConnectionName('connectionName');
