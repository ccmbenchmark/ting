...
class Collection extends atoum
{
    ...
    public function testCollectionShouldDoNothingWithoutHydrator()
    {
        ...
        $this
            ...
            ->then($collection->set(new \CCMBenchmark\Ting\Driver\Mysqli\Result(
                'connectionName',
                'database',
                $mockMysqliResult
            )))
    ...
    public function testFirstShouldReturnFirstItemOfCollection()
    {
        ...
        $result = new \mock\CCMBenchmark\Ting\Driver\Mysqli\Result('connectionName', 'database', $mockMysqliResult);
