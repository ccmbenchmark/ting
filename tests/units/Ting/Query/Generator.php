...
class Generator extends atoum
{
    ...
    public function testGetByCriteriaWithArrayValueAndOrderShouldReturnAQuery()
    {
        ...
        $this
            ...
            ->object($generator->getByCriteria(['name' => ['Xavier','Olivier']], ['name' => 'ASC'], null,$services->get('CollectionFactory'), true))
                ->isInstanceOf('\CCMBenchmark\Ting\Query\Query')
            ->mock($this->mockConnection)
                ->call('master')
                    ->once()
    ...
    public function testGetByCriteriaWithArrayValueAndOrderLimitShouldReturnAQuery()
    {
        ...
        $this
            ...
            ->object($generator->getByCriteria(['name' => ['Xavier','Olivier']], ['name' => 'ASC'], 1,$services->get('CollectionFactory'), true))
                ->isInstanceOf('\CCMBenchmark\Ting\Query\Query')
            ->mock($this->mockConnection)
                ->call('master')
                    ->once()
    ...
    public function testGetByCriteriaWithArrayValueShouldReturnAQuery()
    {
        ...
        $this
            ...
            ->object($generator->getByCriteria(['name' => ['Xavier','Olivier']], null, null,$services->get('CollectionFactory'), true))
                ->isInstanceOf('\CCMBenchmark\Ting\Query\Query')
            ->mock($this->mockConnection)
                ->call('master')
                    ->once()
    ...
    public function testGetByCriteriaShouldReturnAQuery()
    {
        ...
        $this
            ...
            ->object($generator->getByCriteria(['name' => 'Xavier'], null, null,$services->get('CollectionFactory'), true))
                ->isInstanceOf('\CCMBenchmark\Ting\Query\Query')
            ->mock($this->mockConnection)
                ->call('master')
                    ->once()
